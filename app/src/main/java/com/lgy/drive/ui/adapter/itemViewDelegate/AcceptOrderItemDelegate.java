...
public class AcceptOrderItemDelegate implements ItemViewDelegate<OrderBean> {

    private MultiItemTypeAdapter.OnItemClickListener mOnItemClickListener;

    public AcceptOrderItemDelegate(MultiItemTypeAdapter.OnItemClickListener mOnItemClickListener) {
        this.mOnItemClickListener = mOnItemClickListener;
    }

    @Override
    public int getItemViewLayoutId() {
        return R.layout.list_accept_order;
    }

    @Override
    public boolean isForViewType(OrderBean item, int position) {

        return item.orderstate == OrderStateEnum.ACCEPT_ORDER.getCode();
    }
    ...
    public void convert(final ViewHolder holder, OrderBean orderBean,final int position) {
        ...
        holder.setOnClickListener(R.id.btn_accept_call, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mOnItemClickListener.onItemClick(view, holder, position);
            }
        });
        holder.setOnClickListener(R.id.btn_accept_finish, new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mOnItemClickListener.onItemClick(view, holder, position);
            }
