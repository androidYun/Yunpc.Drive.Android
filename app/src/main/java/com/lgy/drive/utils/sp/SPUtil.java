...
public class SPUtil {
     ...
     * 保存在手机里面的文件名
     */
    public static final String FILE_NAME = "yun_pin_car";
    ...
    public static void put(String key, Object object) {
        put(MainApplication.getInstance(), key, object);
    }
    ...
    public static Object get(String key, Object defaultObject) {
        return get(MainApplication.getInstance(), key, defaultObject);
    }
    ...
    public static void remove(String key) {
        remove(MainApplication.getInstance(), key);
    }
    ...
    public static void clear() {
        clear(MainApplication.getInstance());
    }
    ...
    public static boolean contains(String key) {
        return contains(MainApplication.getInstance(), key);
    }
    ...
    public static Map<String, ?> getAll() {
        return getAll(MainApplication.getInstance());
    }
    ...
    public static void putBean(String key,
                               Object obj) {
        SharedPreferences.Editor editor = getSPFile(MainApplication.getInstance()).edit();
    ...
    public static <T> T getBean( String key,
                                Class<T> clazz) {
        String objString = getSPFile(MainApplication.getInstance()).getString(key, "");
